...
export const TRILHAS = [
  ...
  { id: 'mkt-entrevista',  modulo: 'mercado', vertente: 'ambos', ordem: 6, nome: 'Entrevista de Emprego', desc: 'Chegar preparado e brilhar na conversa', iconeNome: 'MessagesSquare', cor: '#1B2A4E' },
  { id: 'mkt-remoto',      modulo: 'mercado', vertente: 'ambos', ordem: 7, nome: 'Trabalho Remoto', desc: 'Trabalhar de casa com foco e organização', iconeNome: 'House', cor: '#E55934' },
  { id: 'mkt-produtividade',modulo: 'mercado', vertente: 'ambos',ordem: 8, nome: 'Produtividade & Organização', desc: 'Fazer o que importa sem se afogar', iconeNome: 'ListChecks', cor: '#1B2A4E' },
  { id: 'mkt-apresenta',   modulo: 'mercado', vertente: 'ambos', ordem: 9, nome: 'Apresentações & Falar em Público', desc: 'Comunicar ideias e convencer', iconeNome: 'Presentation', cor: '#E55934' },
  { id: 'mkt-canva',       modulo: 'mercado', vertente: 'ambos', ordem: 10, nome: 'Design com Canva', desc: 'Criar peças bonitas sem ser designer', iconeNome: 'Palette', cor: '#1B2A4E' },
  { id: 'mkt-financas',    modulo: 'mercado', vertente: 'ambos', ordem: 11, nome: 'Finanças Pessoais', desc: 'Controlar o dinheiro e sair do vermelho', iconeNome: 'PiggyBank', cor: '#E55934' },
  { id: 'mkt-mei',         modulo: 'mercado', vertente: 'ambos', ordem: 12, nome: 'Pequeno Negócio & MEI', desc: 'Formalizar, precificar e empreender', iconeNome: 'Store', cor: '#1B2A4E' },
  { id: 'mkt-vendas',      modulo: 'mercado', vertente: 'ambos', ordem: 13, nome: 'Vender Online', desc: 'Do anúncio ao pós-venda com segurança', iconeNome: 'ShoppingCart', cor: '#E55934' },
  { id: 'mkt-social',      modulo: 'mercado', vertente: 'ambos', ordem: 14, nome: 'Redes Sociais pro Negócio', desc: 'A vitrine digital que atrai clientes', iconeNome: 'Instagram', cor: '#1B2A4E' },
  { id: 'amb-final',   modulo: 'mercado', vertente: 'ambos',      ordem: 15, nome: 'Projeto Final', desc: 'Uma semana simulada usando tudo', iconeNome: 'Layers', cor: '#D4A574' },
