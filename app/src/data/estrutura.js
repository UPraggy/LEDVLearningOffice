...
export const TRILHAS = [
  ...
  { id: 'pc-arquivos', modulo: 'computador', vertente: 'computador', ordem: 6, nome: 'Arquivos e Pastas: Organize seu Computador', desc: 'Explorador, criar/renomear, mover/copiar, busca, extensões, lixeira, pen drive', iconeNome: 'FolderOpen', cor: '#1B2A4E' },
  { id: 'pc-teclado', modulo: 'computador', vertente: 'computador', ordem: 7, nome: 'Teclado e Mouse sem Mistério', desc: 'Teclas-chave, acentos e ç, seleção, atalhos de ouro, mouse completo, digitação, conforto', iconeNome: 'Keyboard', cor: '#3D5A3D' },
  { id: 'pc-email', modulo: 'computador', vertente: 'computador', ordem: 8, nome: 'E-mail de Verdade: Gmail e Outlook', desc: 'Anatomia, escrever/responder, anexos, organizar, spam e golpes, assinatura, candidatura', iconeNome: 'Mail', cor: '#E55934' },
  { id: 'pc-pdf', modulo: 'computador', vertente: 'computador', ordem: 9, nome: 'PDF: o Documento que Não Muda de Forma', desc: 'Ler, criar, juntar/separar, preencher, assinar, comprimir/proteger, escanear, dossiê', iconeNome: 'FileType', cor: '#1B2A4E' },
  { id: 'pc-impressao', modulo: 'computador', vertente: 'computador', ordem: 10, nome: 'Impressão e Digitalização sem Sofrimento', desc: 'Tipos, conectar, imprimir certo, frente/verso, economia, copiar/digitalizar, erros, do celular', iconeNome: 'Printer', cor: '#3D5A3D' },
  { id: 'pc-config', modulo: 'computador', vertente: 'computador', ordem: 11, nome: 'Configurações do Windows sem Medo', desc: 'Painel, tela, som, hora/idioma, personalização, inicialização, energia, contas', iconeNome: 'SlidersHorizontal', cor: '#E55934' },
  { id: 'pc-manutencao', modulo: 'computador', vertente: 'computador', ordem: 12, nome: 'Manutenção: PC Rápido e Saudável', desc: 'Por que fica lento, liberar espaço, atualizações, gerenciador, antivírus, limpeza física, backup, reiniciar', iconeNome: 'Gauge', cor: '#1B2A4E' },
  { id: 'pc-protege', modulo: 'computador', vertente: 'computador', ordem: 13, nome: 'Proteção no PC: Vírus, Senhas e Privacidade', desc: 'Como o PC é invadido, senhas e gerenciador, downloads seguros, navegador, bloqueio de tela, golpes, privacidade, resposta', iconeNome: 'ShieldCheck', cor: '#3D5A3D' },
  { id: 'pc-multimidia', modulo: 'computador', vertente: 'computador', ordem: 14, nome: 'Fotos, Vídeos e Mídia no PC', desc: 'Ver e organizar fotos, recortar imagens, captura de tela, vídeos e player, som e microfone, passar do celular, formatos, coletânea', iconeNome: 'Image', cor: '#E55934' },
  { id: 'pc-apps', modulo: 'computador', vertente: 'computador', ordem: 15, nome: 'Programas e Apps: Equipar o PC', desc: 'O que é instalar, Microsoft Store, site oficial sem cilada, desinstalar, programas nativos, abrir com o programa certo, atalhos, conjunto ideal', iconeNome: 'Download', cor: '#1B2A4E' },
  ...
  { id: 'mob-teclado', modulo: 'celular', vertente: 'celular', ordem: 8, nome: 'Teclado: Digitar, Ditar e Corrigir', desc: 'Escrever sem sofrer: voz, acentos, copiar e colar', iconeNome: 'Keyboard', cor: '#3D5A3D' },
  { id: 'mob-contatos', modulo: 'celular', vertente: 'celular', ordem: 9, nome: 'Ligações, Contatos e Videochamada', desc: 'Falar e ver quem você ama, sem confusão', iconeNome: 'PhoneCall', cor: '#5B7C99' },
  { id: 'mob-apps', modulo: 'celular', vertente: 'celular', ordem: 10, nome: 'Play Store: Instalar Apps com Segurança', desc: 'Baixar, atualizar e limpar apps sem cair em golpe', iconeNome: 'LayoutGrid', cor: '#E55934' },
  { id: 'mob-acess', modulo: 'celular', vertente: 'celular', ordem: 11, nome: 'Acessibilidade: o Celular do Seu Jeito', desc: 'Letra, brilho, som e toque ajustados ao seu conforto', iconeNome: 'Accessibility', cor: '#3D5A3D' },
  { id: 'mob-organiza', modulo: 'celular', vertente: 'celular', ordem: 12, nome: 'Agenda, Alarme e Lembretes', desc: 'O celular vira seu secretário: nunca mais esquecer nada', iconeNome: 'CalendarClock', cor: '#5B7C99' },
  { id: 'mob-bateria', modulo: 'celular', vertente: 'celular', ordem: 13, nome: 'Bateria, Dados e Espaço', desc: 'Celular sempre pronto: carga que dura, pacote que rende, memória leve', iconeNome: 'BatteryCharging', cor: '#3D5A3D' },
  { id: 'mob-entret', modulo: 'celular', vertente: 'celular', ordem: 14, nome: 'Vídeos, Música e Lazer', desc: 'O celular como fonte de alegria: vídeos, música, podcasts, filmes e jogos', iconeNome: 'PlayCircle', cor: '#E55934' },
  { id: 'mob-qr', modulo: 'celular', vertente: 'celular', ordem: 15, nome: 'QR Code, Scanner e Câmera Útil', desc: 'A câmera vira ferramenta: ler QR, pagar, lupa, digitalizar e traduzir', iconeNome: 'ScanLine', cor: '#3D5A3D' },
  ...
  { id: 'pc-excel-pro',modulo: 'mercado', vertente: 'computador', ordem: 2, nome: 'Excel Avançado: Fórmulas que Decidem', desc: 'SE, PROCX, tabela dinâmica e dashboards', iconeNome: 'Sigma', cor: '#1B2A4E' },
  { id: 'pc-ia',       modulo: 'mercado', vertente: 'computador', ordem: 3, nome: 'IA pro Trabalho', desc: 'ChatGPT, Claude e Gemini no dia a dia', iconeNome: 'Sparkles', cor: '#1B2A4E' },
  { id: 'amb-com',     modulo: 'mercado', vertente: 'ambos',      ordem: 4, nome: 'Comunicação Profissional', desc: 'E-mail, etiqueta e escrita clara', iconeNome: 'Send', cor: '#1B2A4E' },
  { id: 'pc-job',      modulo: 'mercado', vertente: 'computador', ordem: 5, nome: 'LinkedIn & Currículo', desc: 'Perfil que recrutador acha', iconeNome: 'Linkedin', cor: '#1B2A4E' },
  { id: 'mkt-carreira',modulo: 'mercado', vertente: 'ambos',      ordem: 6, nome: 'Ofensiva de Carreira', desc: 'Ir atrás da vaga, negociar, se destacar', iconeNome: 'TrendingUp', cor: '#E55934' },
  { id: 'mkt-entrevista',  modulo: 'mercado', vertente: 'ambos', ordem: 7, nome: 'Entrevista de Emprego', desc: 'Chegar preparado e brilhar na conversa', iconeNome: 'MessagesSquare', cor: '#1B2A4E' },
  { id: 'mkt-remoto',      modulo: 'mercado', vertente: 'ambos', ordem: 8, nome: 'Trabalho Remoto', desc: 'Trabalhar de casa com foco e organização', iconeNome: 'House', cor: '#E55934' },
  { id: 'mkt-produtividade',modulo: 'mercado', vertente: 'ambos',ordem: 9, nome: 'Produtividade & Organização', desc: 'Fazer o que importa sem se afogar', iconeNome: 'ListChecks', cor: '#1B2A4E' },
  { id: 'mkt-apresenta',   modulo: 'mercado', vertente: 'ambos', ordem: 10, nome: 'Apresentações & Falar em Público', desc: 'Comunicar ideias e convencer', iconeNome: 'Presentation', cor: '#E55934' },
  { id: 'mkt-canva',       modulo: 'mercado', vertente: 'ambos', ordem: 11, nome: 'Design com Canva', desc: 'Criar peças bonitas sem ser designer', iconeNome: 'Palette', cor: '#1B2A4E' },
  { id: 'mkt-financas',    modulo: 'mercado', vertente: 'ambos', ordem: 12, nome: 'Finanças Pessoais', desc: 'Controlar o dinheiro e sair do vermelho', iconeNome: 'PiggyBank', cor: '#E55934' },
  { id: 'mkt-mei',         modulo: 'mercado', vertente: 'ambos', ordem: 13, nome: 'Pequeno Negócio & MEI', desc: 'Formalizar, precificar e empreender', iconeNome: 'Store', cor: '#1B2A4E' },
  { id: 'mkt-vendas',      modulo: 'mercado', vertente: 'ambos', ordem: 14, nome: 'Vender Online', desc: 'Do anúncio ao pós-venda com segurança', iconeNome: 'ShoppingCart', cor: '#E55934' },
  { id: 'mkt-social',      modulo: 'mercado', vertente: 'ambos', ordem: 15, nome: 'Redes Sociais pro Negócio', desc: 'A vitrine digital que atrai clientes', iconeNome: 'Instagram', cor: '#1B2A4E' },
  { id: 'amb-final',   modulo: 'mercado', vertente: 'ambos',      ordem: 16, nome: 'Projeto Final', desc: 'Uma semana simulada usando tudo', iconeNome: 'Layers', cor: '#D4A574' },
  ...
  { id: 'en-a1-objetos',modulo: 'ingles', vertente: 'ingles', ordem: 5, nome: 'Coisas e Lugares de Casa (A1)', desc: 'this/that, cômodos, plural e preposições de lugar', iconeNome: 'House', cor: '#7A4FB5' },
  { id: 'en-a1-acoes',  modulo: 'ingles', vertente: 'ingles', ordem: 6, nome: 'Ações do Dia a Dia (A1)', desc: 'Present continuous, can/can\'t e imperativo', iconeNome: 'Activity', cor: '#7A4FB5' },
  // A2 — Básico
  { id: 'en-a2-comida', modulo: 'ingles', vertente: 'ingles', ordem: 7, nome: 'Comida e Restaurante (A2)', desc: 'Pedir comida, contáveis/incontáveis, gostos', iconeNome: 'Utensils', cor: '#6A3FA5' },
  { id: 'en-a2-lugares',modulo: 'ingles', vertente: 'ingles', ordem: 8, nome: 'Lugares e Direções (A2)', desc: 'There is/are, preposições, viajar e se orientar', iconeNome: 'MapPin', cor: '#6A3FA5' },
  { id: 'en-a2-passado',modulo: 'ingles', vertente: 'ingles', ordem: 9, nome: 'Falando do Passado (A2)', desc: 'Past simple: contar o que aconteceu', iconeNome: 'History', cor: '#6A3FA5' },
  { id: 'en-a2-planos', modulo: 'ingles', vertente: 'ingles', ordem: 10, nome: 'Planos e Futuro (A2)', desc: 'Going to e will: falar de planos e previsões', iconeNome: 'CalendarClock', cor: '#6A3FA5' },
  { id: 'en-a2-compras',modulo: 'ingles', vertente: 'ingles', ordem: 11, nome: 'Fazendo Compras (A2)', desc: 'Lojas, roupas, preços, some/any e would like', iconeNome: 'ShoppingCart', cor: '#6A3FA5' },
  { id: 'en-a2-saude',  modulo: 'ingles', vertente: 'ingles', ordem: 12, nome: 'Saúde e Corpo (A2)', desc: 'Partes do corpo, sintomas, should e must', iconeNome: 'Stethoscope', cor: '#6A3FA5' },
  { id: 'en-a2-comparar',modulo: 'ingles', vertente: 'ingles', ordem: 13, nome: 'Comparando Coisas (A2)', desc: 'Comparativo, superlativo, as...as, too e enough', iconeNome: 'Scale', cor: '#6A3FA5' },
  // B1 — Intermediário
  { id: 'en-b1-conversa',modulo: 'ingles', vertente: 'ingles', ordem: 14, nome: 'Conversação e Opiniões (B1)', desc: 'Present perfect, opinar e manter uma conversa', iconeNome: 'MessageSquare', cor: '#5A2F95' },
  { id: 'en-b1-trabalho',modulo: 'ingles', vertente: 'ingles', ordem: 15, nome: 'Inglês para o Trabalho (B1)', desc: 'Currículo, entrevista e e-mails em inglês', iconeNome: 'Briefcase', cor: '#5A2F95' },
  { id: 'en-b1-mundo',  modulo: 'ingles', vertente: 'ingles', ordem: 16, nome: 'Histórias e Mundo (B1)', desc: 'Condicionais, conectar ideias e narrar', iconeNome: 'Globe2', cor: '#5A2F95' },
  { id: 'en-b1-viagem', modulo: 'ingles', vertente: 'ingles', ordem: 17, nome: 'Viajar com Confiança (B1)', desc: 'Aeroporto, hotel, direções e present perfect', iconeNome: 'Plane', cor: '#5A2F95' },
  { id: 'en-b1-telefone',modulo: 'ingles', vertente: 'ingles', ordem: 18, nome: 'No Telefone e Online (B1)', desc: 'Ligações, recados, e-mails e quando a comunicação falha', iconeNome: 'Phone', cor: '#5A2F95' },
  // B2 — Avançado
  { id: 'en-b2-expressoes',modulo: 'ingles', vertente: 'ingles', ordem: 19, nome: 'Expressões e Idioms (B2)', desc: 'Idioms, phrasal verbs, collocations e soar natural', iconeNome: 'Sparkles', cor: '#4A1F85' },
  { id: 'en-b2-midia',  modulo: 'ingles', vertente: 'ingles', ordem: 20, nome: 'Inglês na Mídia (B2)', desc: 'Notícias, filmes, música, podcasts e redes', iconeNome: 'Newspaper', cor: '#4A1F85' },
  { id: 'en-b2-fluencia',modulo: 'ingles', vertente: 'ingles', ordem: 21, nome: 'Fluência e Conversação (B2)', desc: 'Manter a conversa, opinar, parafrasear, contar e debater', iconeNome: 'Mic', cor: '#4A1F85' },
];
...
export const MISSOES = {
  ...
  'pc-arquivos': [
    { id: 1, titulo: 'O que é arquivo e o que é pasta', desc: 'As duas ideias que destravam tudo', tempo: 8, xp: 40 },
    { id: 2, titulo: 'O Explorador de Arquivos: sua casa digital', desc: 'Navegar sem se perder', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Criar e renomear pastas', desc: 'Vire quem acha as coisas', tempo: 8, xp: 50 },
    { id: 4, titulo: 'Mover, copiar e colar arquivos', desc: 'Tire tudo do lugar errado', tempo: 10, xp: 60 },
    { id: 5, titulo: 'Buscar e ordenar: ache qualquer arquivo', desc: 'Nunca mais "sumiu"', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Extensões: .pdf, .docx, .jpg e quem abre', desc: 'O sobrenome do arquivo', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Lixeira: apagar e recuperar com segurança', desc: 'Apague sem medo', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Pen drive e HD externo: copiar e ejetar', desc: 'Transporte e backup sem corromper', tempo: 10, xp: 60 },
    { id: 9, titulo: 'Projeto: organize a pasta da sua vida', desc: 'Estrutura completa + backup', tempo: 18, xp: 120 },
  ],
  'pc-teclado': [
    { id: 1, titulo: 'O mapa do teclado: onde fica cada coisa', desc: 'As teclas que você usa de verdade', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Acentos e o ç: escrever português direito', desc: 'Acento primeiro, vogal depois', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Selecionar texto: a base de tudo', desc: 'Marcar antes de agir', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Copiar, colar e desfazer: atalhos de ouro', desc: 'Ctrl+C, V, X, Z', tempo: 9, xp: 60 },
    { id: 5, titulo: 'O mouse por inteiro', desc: 'Clique, duplo, direito e rolagem', tempo: 8, xp: 50 },
    { id: 6, titulo: 'Atalhos que mudam o jogo', desc: 'Janelas, abas, salvar e print', tempo: 9, xp: 60 },
    { id: 7, titulo: 'Digitação com as duas mãos', desc: 'Ganhe velocidade sem dor', tempo: 10, xp: 60 },
    { id: 8, titulo: 'Ajustes de conforto: teclado e mouse', desc: 'A máquina se adapta a você', tempo: 8, xp: 50 },
    { id: 9, titulo: 'Projeto: preencha um formulário do início ao fim', desc: 'Tudo junto numa tarefa real', tempo: 16, xp: 110 },
  ],
  'pc-email': [
    { id: 1, titulo: 'O que é um e-mail e por que ele ainda importa', desc: 'Seu endereço oficial na internet', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Escrever e enviar seu primeiro e-mail', desc: 'Para, assunto e mensagem', tempo: 10, xp: 60 },
    { id: 3, titulo: 'Responder, encaminhar e o "responder a todos"', desc: 'Três botões, três destinos', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Anexos: enviar e abrir com segurança', desc: 'O clipe e o cuidado com vírus', tempo: 10, xp: 60 },
    { id: 5, titulo: 'Organizar a caixa: buscar, marcar e arquivar', desc: 'Caixa limpa, nada perdido', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Spam e golpes: reconhecer e-mails perigosos', desc: 'Phishing não engana você', tempo: 10, xp: 60 },
    { id: 7, titulo: 'Assinatura e e-mail profissional', desc: 'Causar boa impressão', tempo: 9, xp: 50 },
    { id: 8, titulo: 'E-mail no celular e no PC: sincronizado', desc: 'Sua conta na nuvem, com segurança', tempo: 8, xp: 50 },
    { id: 9, titulo: 'Projeto: candidatura completa por e-mail', desc: 'Assunto, mensagem, currículo em PDF', tempo: 18, xp: 120 },
  ],
  'pc-pdf': [
    { id: 1, titulo: 'O que é PDF e por que virou o documento oficial', desc: 'A forma travada que chega igual', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Abrir, ler e navegar um PDF', desc: 'Zoom, páginas e Ctrl+F', tempo: 8, xp: 40 },
    { id: 3, titulo: 'Criar um PDF a partir de qualquer documento', desc: 'Se dá pra imprimir, vira PDF', tempo: 10, xp: 60 },
    { id: 4, titulo: 'Juntar e separar páginas de PDF', desc: 'Tudo num só ou só a página certa', tempo: 10, xp: 60 },
    { id: 5, titulo: 'Preencher formulários em PDF sem imprimir', desc: 'Digitar direto no documento', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Assinar um PDF digitalmente', desc: 'Do desenho ao gov.br', tempo: 10, xp: 60 },
    { id: 7, titulo: 'Comprimir e proteger: PDF leve e seguro', desc: 'Caber no upload e trancar com senha', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Escanear com o celular e gerar PDF', desc: 'Seu scanner de bolso', tempo: 9, xp: 50 },
    { id: 9, titulo: 'Projeto: monte um dossiê de documentos', desc: 'Escanear, juntar, comprimir e proteger', tempo: 18, xp: 120 },
  ],
  'pc-impressao': [
    { id: 1, titulo: 'Conhecendo a impressora: tipos e partes', desc: 'Jato, laser, multifuncional e suas partes', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Conectar a impressora ao computador', desc: 'USB, Wi-Fi e o famoso "não aparece"', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Imprimir certo: a tela de impressão', desc: 'Páginas, cópias e prévia sem desperdício', tempo: 10, xp: 60 },
    { id: 4, titulo: 'Frente e verso, cor e economia de tinta', desc: 'Gastar metade do papel e da tinta', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Copiar e digitalizar na multifuncional', desc: 'O scanner em ação, sem papelaria', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Resolver os erros mais comuns', desc: 'Papel preso, fila travada e riscos', tempo: 10, xp: 60 },
    { id: 7, titulo: 'Imprimir do celular e em lugares públicos', desc: 'Sem PC e sem impressora própria', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Projeto: imprima e organize um documento oficial', desc: 'Imprimir, copiar e digitalizar o ciclo todo', tempo: 16, xp: 110 },
  ],
  'pc-config': [
    { id: 1, titulo: 'O painel de Configurações: o cérebro do PC', desc: 'Onde tudo se ajusta, sem medo', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Tela do seu jeito: letra maior, brilho e tema', desc: 'Conforto visual e modo escuro', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Som, volume e dispositivos de áudio', desc: 'Saída, entrada e o som no lugar certo', tempo: 8, xp: 40 },
    { id: 4, titulo: 'Hora, data e idioma certos', desc: 'Relógio automático e teclado ABNT2', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Personalizar a área de trabalho e a barra', desc: 'Papel de parede, fixar e atalhos', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Programas que abrem sozinhos', desc: 'Inicialização leve, PC mais rápido', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Energia: bateria, suspensão e desligar certo', desc: 'Bateria que rende e PC saudável', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Contas de usuário e o administrador', desc: 'Espaços próprios e a senha de admin', tempo: 9, xp: 50 },
    { id: 9, titulo: 'Projeto: configure um computador do zero', desc: 'O ritual completo pra deixar tudo seu', tempo: 16, xp: 110 },
  ],
  'pc-manutencao': [
    { id: 1, titulo: 'Por que o computador fica lento com o tempo', desc: 'As causas reais — e que têm conserto', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Liberar espaço em disco com segurança', desc: 'Apagar o lixo sem perder o que importa', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Atualizações do Windows: por que e quando', desc: 'Segurança em dia, no seu horário', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Gerenciador de Tarefas: fechar o que travou', desc: 'Socorro a travamentos sem perder nada', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Antivírus e o Windows Defender', desc: 'A proteção gratuita que já vem no PC', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Limpeza física e temperatura do PC', desc: 'Poeira e calor: inimigos silenciosos', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Backup: nunca perca seus arquivos', desc: 'O seguro mais importante da vida digital', tempo: 10, xp: 60 },
    { id: 8, titulo: 'Desinstalar programas e o reiniciar mágico', desc: 'Remover penetras e o poder do reinício', tempo: 8, xp: 50 },
    { id: 9, titulo: 'Projeto: rotina que mantém o PC novo', desc: 'Seu plano de cuidados por frequência', tempo: 16, xp: 110 },
  ],
  'pc-protege': [
    { id: 1, titulo: 'Como um computador é invadido (sem mistério)', desc: 'Quase sempre você abre a porta sem saber', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Senhas fortes e o gerenciador de senhas', desc: 'Fortes, únicas e sem decorar nenhuma', tempo: 10, xp: 60 },
    { id: 3, titulo: 'Baixar programas com segurança', desc: 'A fonte importa mais que o programa', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Navegador seguro: extensões e pop-ups', desc: 'Cuidar da porta principal do PC', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Bloqueio de tela e proteger o acesso', desc: 'Garantir que só você abre a máquina', tempo: 8, xp: 40 },
    { id: 6, titulo: 'Golpes que aparecem na tela do PC', desc: 'O medo é a arma: reconheça a farsa', tempo: 10, xp: 60 },
    { id: 7, titulo: 'Privacidade: seus dados e a câmera', desc: 'Você decide o que cada app acessa', tempo: 8, xp: 50 },
    { id: 8, titulo: 'O que fazer se já foi infectado', desc: 'Reagir na ordem certa limita o dano', tempo: 9, xp: 50 },
    { id: 9, titulo: 'Projeto: blindagem completa do PC', desc: 'O checklist que protege de verdade', tempo: 16, xp: 110 },
  ],
  'pc-multimidia': [
    { id: 1, titulo: 'Ver e organizar suas fotos no PC', desc: 'A tela grande transforma a bagunça em acervo', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Recortar e ajustar uma imagem', desc: 'O app Fotos já edita o essencial', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Captura de tela: fotografar a tela', desc: 'O print que guarda e mostra qualquer coisa', tempo: 8, xp: 40 },
    { id: 4, titulo: 'Assistir vídeos e usar o player', desc: '"Não abre" quase sempre é formato', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Som, fones e microfone no PC', desc: 'Escolher a saída e a entrada certas', tempo: 8, xp: 40 },
    { id: 6, titulo: 'Passar fotos do celular pro PC', desc: 'Cabo ou nuvem: libere espaço e faça backup', tempo: 10, xp: 60 },
    { id: 7, titulo: 'Formatos: JPG, PNG, MP4 e MP3', desc: 'A extensão diz o tipo da mídia', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Projeto: coletânea de memórias', desc: 'Do celular lotado a uma seleção pronta', tempo: 16, xp: 110 },
  ],
  'pc-apps': [
    { id: 1, titulo: 'O que é "instalar um programa"', desc: 'Instalar é adicionar uma capacidade ao PC', tempo: 8, xp: 40 },
    { id: 2, titulo: 'A Microsoft Store: instalar seguro', desc: 'A "lojinha" do Windows com apps verificados', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Instalar de site oficial sem cilada', desc: 'A fonte importa mais que o programa', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Desinstalar o que não usa mais', desc: 'Apagar o ícone não desinstala', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Os programas que já vêm no Windows', desc: 'Um kit básico que você já tem', tempo: 8, xp: 40 },
    { id: 6, titulo: 'Abrir arquivos com o programa certo', desc: 'Programa padrão e "Abrir com"', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Atalhos: área de trabalho e barra', desc: 'Favoritos a um clique todo dia', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Projeto: conjunto ideal de programas', desc: 'Um PC enxuto, seguro e sob medida', tempo: 16, xp: 110 },
  ],
  ...
  'mob-teclado': [
    { id: 1, titulo: 'Conhecer o teclado da tela', desc: 'As teclas que importam', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Maiúsculas, números e símbolos', desc: 'Achar qualquer caractere', tempo: 8, xp: 40 },
    { id: 3, titulo: 'Autocorreção e sugestões', desc: 'Deixar o teclado ajudar', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Ditado por voz', desc: 'Falar em vez de digitar', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Copiar e colar no celular', desc: 'Mover texto sem redigitar', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Emojis e pontuação', desc: 'Dar tom à mensagem', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Acentos, cedilha e idiomas', desc: 'Português correto e mais', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Escrever deslizando e atalhos', desc: 'Swipe e truques de digitação', tempo: 9, xp: 50 },
    { id: 9, titulo: 'Projeto: mensagem completa', desc: 'Escrever com tranquilidade', tempo: 16, xp: 110 },
  ],
  'mob-contatos': [
    { id: 1, titulo: 'Salvar um contato na agenda', desc: 'Guardar pessoas com nome', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Fazer uma ligação', desc: 'Por contato ou número', tempo: 8, xp: 40 },
    { id: 3, titulo: 'Atender e recusar chamadas', desc: 'Controle de quem te liga', tempo: 8, xp: 40 },
    { id: 4, titulo: 'Viva-voz, mudo e teclado', desc: 'Botões da chamada', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Histórico e retornar ligações', desc: 'Quem ligou e ligar de volta', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Organizar e editar contatos', desc: 'Agenda limpa e útil', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Videochamada', desc: 'Ver quem você ama', tempo: 10, xp: 60 },
    { id: 8, titulo: 'Identificar e bloquear incômodos', desc: 'Paz e proteção', tempo: 8, xp: 50 },
    { id: 9, titulo: 'Projeto: agenda e família por perto', desc: 'Telefone que aproxima', tempo: 16, xp: 110 },
  ],
  'mob-apps': [
    { id: 1, titulo: 'O que é um app e onde ele mora', desc: 'Cada ícone é um aplicativo', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Abrir a loja de apps', desc: 'Play Store ou App Store', tempo: 8, xp: 40 },
    { id: 3, titulo: 'Buscar e reconhecer o app certo', desc: 'O oficial, não a cópia falsa', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Instalar seu primeiro app', desc: 'Do toque ao ícone na tela', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Permissões: o que o app acessa', desc: 'Câmera, microfone, localização', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Atualizar apps: por que e como', desc: 'Melhorias e segurança', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Desinstalar e liberar espaço', desc: 'Faxina que dá leveza', tempo: 8, xp: 40 },
    { id: 8, titulo: 'Apps falsos e armadilhas', desc: 'Reconhecer e evitar golpes', tempo: 9, xp: 50 },
    { id: 9, titulo: 'Projeto: equipar o celular com segurança', desc: 'Caixa de ferramentas sob medida', tempo: 16, xp: 110 },
  ],
  'mob-acess': [
    { id: 1, titulo: 'O celular se adapta a você', desc: 'O que é acessibilidade', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Letra e conteúdo maiores', desc: 'Ler sem apertar os olhos', tempo: 8, xp: 40 },
    { id: 3, titulo: 'Brilho, contraste e modo escuro', desc: 'Tela confortável sempre', tempo: 8, xp: 40 },
    { id: 4, titulo: 'Lupa e zoom: ampliar na hora', desc: 'Rótulos e detalhes miúdos', tempo: 9, xp: 50 },
    { id: 5, titulo: 'O celular lê a tela em voz alta', desc: 'Ouvir em vez de ler', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Som, volume e legendas', desc: 'Ouvir e ler o áudio', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Toque mais fácil e atalhos', desc: 'Mãos firmes ou trêmulas', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Projeto: o celular configurado pra você', desc: 'Aparelho sob medida', tempo: 16, xp: 110 },
  ],
  'mob-organiza': [
    { id: 1, titulo: 'O celular é sua agenda e secretário', desc: 'Memória externa confiável', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Despertador e alarmes', desc: 'Acordar e marcar horários', tempo: 8, xp: 40 },
    { id: 3, titulo: 'Cronômetro e timer', desc: 'Medir o tempo e ser avisado', tempo: 8, xp: 40 },
    { id: 4, titulo: 'Calendário: marcar compromissos', desc: 'Consultas e encontros com aviso', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Lembretes de tarefas', desc: 'Nada a fazer se perde', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Notas rápidas e listas', desc: 'O caderno infinito do celular', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Lembretes de remédio e contas', desc: 'Saúde e bolso em dia', tempo: 8, xp: 50 },
    { id: 8, titulo: 'Projeto: organizar a semana com o celular', desc: 'Um sistema que lembra de tudo', tempo: 16, xp: 110 },
  ],
  'mob-bateria': [
    { id: 1, titulo: 'Entendendo a bateria do celular', desc: 'A reserva de energia', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Fazer a carga durar o dia', desc: 'Ajustes que poupam bateria', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Carregar do jeito certo', desc: 'Mitos e cuidados reais', tempo: 8, xp: 40 },
    { id: 4, titulo: 'Wi-Fi e dados móveis: a diferença', desc: 'Internet sem desperdício', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Economizar a internet do pacote', desc: 'Franquia que rende o mês', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Entender o espaço de armazenamento', desc: 'A gaveta de guardar tudo', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Liberar espaço sem perder o que importa', desc: 'Faxina segura', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: celular saudável e leve', desc: 'Manutenção completa', tempo: 16, xp: 110 },
  ],
  'mob-entret': [
    { id: 1, titulo: 'O celular é uma janela de entretenimento', desc: 'Lazer sob demanda', tempo: 8, xp: 40 },
    { id: 2, titulo: 'YouTube: vídeos de tudo', desc: 'A videoteca infinita', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Música e rádio na hora que quiser', desc: 'Trilha sonora do dia', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Podcasts e audiolivros: ouvir e aprender', desc: 'Companhia pelos ouvidos', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Fones de ouvido: ouvir com conforto', desc: 'Com fio e Bluetooth', tempo: 8, xp: 40 },
    { id: 6, titulo: 'Filmes e séries: streaming e assinaturas', desc: 'Entender o que se paga', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Jogos e passatempos', desc: 'Diversão que faz bem', tempo: 8, xp: 40 },
    { id: 8, titulo: 'Projeto: seu cantinho de lazer no celular', desc: 'Curar o que você ama', tempo: 16, xp: 110 },
  ],
  'mob-qr': [
    { id: 1, titulo: 'O que é um QR Code', desc: 'O quadradinho atalho', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Lendo um QR Code com a câmera', desc: 'Apontar e tocar no aviso', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Ler QR Code com segurança', desc: 'Evitar o golpe do QR falso', tempo: 9, xp: 50 },
    { id: 4, titulo: 'QR Code do PIX: pagar pelo quadradinho', desc: 'Conferir nome e valor', tempo: 9, xp: 50 },
    { id: 5, titulo: 'A câmera como lupa e ferramenta', desc: 'Enxergar o miúdo', tempo: 8, xp: 40 },
    { id: 6, titulo: 'Escanear documentos com a câmera', desc: 'Scanner de bolso em PDF', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Traduzir e buscar pela câmera', desc: 'Google Lens', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: a câmera que resolve o dia a dia', desc: 'A câmera útil completa', tempo: 16, xp: 110 },
  ],
  ...
  'pc-excel-pro': [
    { id: 1, titulo: 'O segredo do cifrão: referência fixa ($)', desc: 'Relativa, absoluta e mista', tempo: 12, xp: 60 },
    { id: 2, titulo: 'A função SE: a planilha que decide', desc: 'Se isso, então aquilo', tempo: 14, xp: 70 },
    { id: 3, titulo: 'SE dentro de SE: faixas e categorias', desc: 'Três ou mais respostas', tempo: 12, xp: 70 },
    { id: 4, titulo: 'E / OU: várias condições de uma vez', desc: 'Critérios combinados no SE', tempo: 11, xp: 60 },
    { id: 5, titulo: 'CONT.SE e CONT.SES: contar com critério', desc: 'Contagem filtrada', tempo: 12, xp: 60 },
    { id: 6, titulo: 'SOMASE e SOMASES: somar com critério', desc: 'O coração do relatório', tempo: 13, xp: 70 },
    { id: 7, titulo: 'Erros sob controle: SE.ERRO', desc: 'Adeus #N/D e #DIV/0!', tempo: 9, xp: 50 },
    { id: 8, titulo: 'PROCX (XLOOKUP): o sucessor do PROCV', desc: 'Buscar entre tabelas sem medo', tempo: 16, xp: 100 },
    { id: 9, titulo: 'Funções de texto: juntar, separar e limpar', desc: 'Dados bagunçados padronizados', tempo: 12, xp: 60 },
    { id: 10, titulo: 'Datas que calculam: prazos e idade', desc: 'HOJE, dias úteis, DATADIF', tempo: 11, xp: 60 },
    { id: 11, titulo: 'Listas suspensas: validação de dados', desc: 'Dropdowns que padronizam', tempo: 10, xp: 55 },
    { id: 12, titulo: 'Formatação condicional: a planilha que se pinta', desc: 'Cores que seguem regras', tempo: 10, xp: 55 },
    { id: 13, titulo: 'Tabela dinâmica: resumir milhares de linhas', desc: 'O pulo do gato da análise', tempo: 16, xp: 90 },
    { id: 14, titulo: 'Projeto: Dashboard de Vendas completo', desc: 'PROCX + SOMASES + dinâmica + condicional', tempo: 30, xp: 160 },
  ],
  'pc-ia': [
  ...
  'mkt-entrevista': [
    { id: 1, titulo: 'A entrevista é uma conversa', desc: 'Não é interrogatório: troca de mão dupla', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Pesquisar a empresa e a vaga', desc: 'Chegar sabendo onde vai pisar', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Respondendo "fale sobre você"', desc: 'O pitch que abre a entrevista', tempo: 9, xp: 50 },
    { id: 4, titulo: 'As perguntas mais comuns', desc: 'O que sempre cai e como responder', tempo: 8, xp: 40 },
    { id: 5, titulo: 'Pontos fortes e fracos', desc: 'Responder sem cair em armadilha', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Histórias com o método STAR', desc: 'Provar com exemplos, não adjetivos', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Entrevista por vídeo', desc: 'O preparo extra de luz, som e tela', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: simular uma entrevista', desc: 'Ensaiar do começo ao fim', tempo: 16, xp: 110 },
  ],
  'mkt-remoto': [
    { id: 1, titulo: 'O que é trabalhar de casa', desc: 'Liberdade com responsabilidade', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Montando seu cantinho', desc: 'Espaço de trabalho que funciona', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Rotina e disciplina', desc: 'Sem chefe ao lado, você se cobra', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Comunicação à distância', desc: 'Escrever claro e responder no prazo', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Ferramentas do remoto', desc: 'Chamadas, chats e arquivos na nuvem', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Separar trabalho e vida', desc: 'Pôr ponto final no expediente', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Foco e produtividade em casa', desc: 'Domar distrações do lar', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: sua rotina remota', desc: 'Organizar o dia de trabalho em casa', tempo: 16, xp: 110 },
  ],
  'mkt-produtividade': [
    { id: 1, titulo: 'Produtividade de verdade', desc: 'Fazer o que importa, não correr mais', tempo: 8, xp: 40 },
    { id: 2, titulo: 'A lista de tarefas que funciona', desc: 'Tirar tudo da cabeça pro papel', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Urgente x importante', desc: 'Priorizar o que de fato pesa', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Planejar a semana', desc: 'Usar a agenda a seu favor', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Vencendo a procrastinação', desc: 'Começar pequeno e destravar', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Organizando a vida digital', desc: 'Arquivos, e-mail e notificações', tempo: 8, xp: 40 },
    { id: 7, titulo: 'O poder dos hábitos', desc: 'Pouco e constante vence', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: seu sistema', desc: 'Montar sua rotina de produtividade', tempo: 16, xp: 110 },
  ],
  'mkt-apresenta': [
    { id: 1, titulo: 'Por que saber apresentar', desc: 'Comunicar bem muda sua carreira', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Vencendo o medo do público', desc: 'Nervosismo vira aliado', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Estruturando a mensagem', desc: 'Início, meio e fim com clareza', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Slides que ajudam', desc: 'Apoio visual, não muleta de texto', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Voz e corpo', desc: 'Como você fala importa tanto quanto o quê', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Histórias que convencem', desc: 'Emoção que gruda a mensagem', tempo: 9, xp: 50 },
    { id: 7, titulo: 'Perguntas e imprevistos', desc: 'Manter a calma quando foge do roteiro', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: prepare e ensaie', desc: 'Uma apresentação do zero ao palco', tempo: 16, xp: 110 },
  ],
  'mkt-canva': [
    { id: 1, titulo: 'O que é o Canva', desc: 'Design fácil sem ser designer', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Conta e tela do Canva', desc: 'Conhecer o ambiente de trabalho', tempo: 9, xp: 50 },
    { id: 3, titulo: 'O poder dos modelos', desc: 'Começar do pronto e personalizar', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Editando textos e cores', desc: 'Deixar com a sua cara', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Imagens e elementos', desc: 'Fotos, ícones e formas', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Princípios de bom design', desc: 'Alinhamento, contraste e respiro', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Baixando e compartilhando', desc: 'Exportar no formato certo', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: peças reais', desc: 'Criar materiais que você vai usar', tempo: 16, xp: 110 },
  ],
  'mkt-financas': [
    { id: 1, titulo: 'Cuidar do dinheiro muda a vida', desc: 'Controle traz paz e escolhas', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Pra onde vai seu dinheiro', desc: 'Enxergar todos os gastos', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Um orçamento que funciona', desc: 'Cada real com um destino', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Cortar gastos sem sofrer', desc: 'Onde economizar de verdade', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Saindo das dívidas', desc: 'Plano pra sair do vermelho', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Reserva de emergência', desc: 'Seu colchão de segurança', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Fazer o dinheiro render', desc: 'Primeiros passos pra investir', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: plano financeiro', desc: 'Montar seu plano pessoal', tempo: 16, xp: 110 },
  ],
  'mkt-mei': [
    { id: 1, titulo: 'Da ideia ao negócio', desc: 'Será que vale a pena?', tempo: 8, xp: 40 },
    { id: 2, titulo: 'O que é o MEI', desc: 'Por que vale formalizar', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Como abrir seu MEI', desc: 'Passo a passo grátis e online', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Dinheiro pessoal x negócio', desc: 'Separar pra não se enrolar', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Cobrando o preço certo', desc: 'Precificar pra ter lucro', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Nota fiscal e obrigações', desc: 'DAS, DASN e o que cumprir', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Conquistar e manter clientes', desc: 'Ser achado, encantar, fidelizar', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: planeje seu negócio', desc: 'Da validação à formalização', tempo: 16, xp: 110 },
  ],
  'mkt-vendas': [
    { id: 1, titulo: 'Por que e onde vender online', desc: 'Canais e por onde começar', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Fotos e descrições que vendem', desc: 'Mostrar bem e descrever honesto', tempo: 9, xp: 50 },
    { id: 3, titulo: 'Atendimento e fechamento', desc: 'Responder rápido e fechar a venda', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Pagamentos com segurança', desc: 'Confirmar na conta antes de entregar', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Frete, embalagem e entrega', desc: 'Chegar bem e no prazo', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Avaliações e reputação', desc: 'A confiança que vende sozinha', tempo: 8, xp: 40 },
    { id: 7, titulo: 'Promoções e fidelização', desc: 'Divulgar e fazer voltar', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: primeira venda online', desc: 'Um produto do anúncio ao pós-venda', tempo: 16, xp: 110 },
  ],
  'mkt-social': [
    { id: 1, titulo: 'Redes como vitrine', desc: 'Divulgar de graça pro mundo', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Rede certa e perfil', desc: 'Montar a recepção do negócio', tempo: 9, xp: 50 },
    { id: 3, titulo: 'O que postar', desc: 'Conteúdo que atrai, não só vende', tempo: 9, xp: 50 },
    { id: 4, titulo: 'Constância e planejamento', desc: 'Aparecer sempre, sem sufoco', tempo: 9, xp: 50 },
    { id: 5, titulo: 'Posts que prendem', desc: 'Visual e legenda que param o dedo', tempo: 9, xp: 50 },
    { id: 6, titulo: 'Engajamento e comunidade', desc: 'Rede social é conversa', tempo: 8, xp: 40 },
    { id: 7, titulo: 'WhatsApp e impulsionar', desc: 'Fechar a venda e alcançar mais', tempo: 9, xp: 50 },
    { id: 8, titulo: 'Projeto: presença digital', desc: 'Vitrine do negócio no ar', tempo: 16, xp: 110 },
  ],
  'amb-final': [
  ...
  'en-a1-objetos': [
    { id: 1, titulo: 'This, that, these, those', desc: 'Apontar coisas perto e longe', tempo: 8, xp: 40 },
    { id: 2, titulo: 'A casa e seus cômodos', desc: 'Kitchen, bedroom, bathroom...', tempo: 10, xp: 60 },
    { id: 3, titulo: 'Plural e a/an', desc: 'Um, uma e o plural das coisas', tempo: 10, xp: 70 },
    { id: 4, titulo: 'Preposições de lugar', desc: 'in, on, under, next to', tempo: 11, xp: 70 },
    { id: 5, titulo: 'Have got: o que eu tenho', desc: 'Dizer o que você possui', tempo: 11, xp: 80 },
    { id: 6, titulo: 'Projeto: o tour da sua casa', desc: 'Descreva cada cômodo em inglês', tempo: 18, xp: 120 },
  ],
  'en-a1-acoes': [
    { id: 1, titulo: 'O que está acontecendo agora', desc: 'Present continuous (-ing)', tempo: 8, xp: 40 },
    { id: 2, titulo: 'Verbos de ação comuns', desc: 'eat, run, read, work...', tempo: 10, xp: 60 },
    { id: 3, titulo: 'Can / can\'t: habilidades', desc: 'Dizer o que sabe e não sabe fazer', tempo: 10, xp: 70 },
    { id: 4, titulo: 'Imperativo: ordens e instruções', desc: 'Open, sit, don\'t touch', tempo: 11, xp: 70 },
    { id: 5, titulo: 'Rotina x agora', desc: 'Present simple vs continuous', tempo: 11, xp: 80 },
    { id: 6, titulo: 'Projeto: narre o que acontece', desc: 'Descreva ações numa cena', tempo: 18, xp: 120 },
  ],
  'en-a2-compras': [
    { id: 1, titulo: 'Lojas, roupas e preços', desc: 'Vocabulário de compras', tempo: 11, xp: 80 },
    { id: 2, titulo: 'Some, any, much, many', desc: 'Quantidades em inglês', tempo: 12, xp: 80 },
    { id: 3, titulo: 'Numa loja: pedir e pagar', desc: 'Diálogo de compra', tempo: 11, xp: 80 },
    { id: 4, titulo: 'Would like: pedir com educação', desc: 'I\'d like..., would you like?', tempo: 11, xp: 80 },
    { id: 5, titulo: 'Trocas, tamanhos e problemas', desc: 'Resolver trocas e tamanhos', tempo: 12, xp: 90 },
    { id: 6, titulo: 'Projeto: diálogo de compras', desc: 'Encene uma compra completa', tempo: 20, xp: 130 },
  ],
  'en-a2-saude': [
    { id: 1, titulo: 'Partes do corpo', desc: 'Head, arm, leg, stomach...', tempo: 11, xp: 80 },
    { id: 2, titulo: 'Sintomas e doenças', desc: 'I have a headache, a cold...', tempo: 11, xp: 80 },
    { id: 3, titulo: 'No médico e na farmácia', desc: 'Pedir ajuda e remédios', tempo: 12, xp: 90 },
    { id: 4, titulo: 'Should: dar conselhos', desc: 'You should rest, see a doctor', tempo: 11, xp: 80 },
    { id: 5, titulo: 'Must e have to: obrigação', desc: 'O que você precisa fazer', tempo: 12, xp: 90 },
    { id: 6, titulo: 'Projeto: uma consulta médica', desc: 'Encene uma ida ao médico', tempo: 20, xp: 130 },
  ],
  'en-a2-comparar': [
    { id: 1, titulo: 'Adjetivos para descrever', desc: 'big, small, expensive, fast', tempo: 11, xp: 80 },
    { id: 2, titulo: 'Comparativo: maior, mais caro', desc: '-er / more + than', tempo: 12, xp: 90 },
    { id: 3, titulo: 'Superlativo: o maior de todos', desc: 'the -est / the most', tempo: 12, xp: 90 },
    { id: 4, titulo: 'As...as: igual ou não', desc: 'as big as, not as... as', tempo: 11, xp: 80 },
    { id: 5, titulo: 'Too e enough', desc: 'too expensive, big enough', tempo: 12, xp: 90 },
    { id: 6, titulo: 'Projeto: comparar e decidir', desc: 'Compare opções e escolha', tempo: 20, xp: 130 },
  ],
  'en-b1-viagem': [
    { id: 1, titulo: 'No aeroporto e check-in', desc: 'Embarque, bagagem, portão', tempo: 12, xp: 90 },
    { id: 2, titulo: 'Hotel e reservas', desc: 'Reservar, check-in, pedidos', tempo: 13, xp: 100 },
    { id: 3, titulo: 'Pedir e dar direções', desc: 'How do I get to...?', tempo: 13, xp: 100 },
    { id: 4, titulo: 'Resolver problemas na viagem', desc: 'Atrasos, perdas, imprevistos', tempo: 13, xp: 100 },
    { id: 5, titulo: 'Experiências de viagem', desc: 'Present perfect: ever/never', tempo: 13, xp: 100 },
    { id: 6, titulo: 'Projeto: planeje e conte uma viagem', desc: 'Futuro, passado e experiências', tempo: 22, xp: 140 },
  ],
  'en-b1-telefone': [
    { id: 1, titulo: 'Atender e fazer ligações', desc: 'This is... speaking, hold on', tempo: 12, xp: 90 },
    { id: 2, titulo: 'Deixar e anotar recados', desc: 'Take/leave a message, spell', tempo: 13, xp: 100 },
    { id: 3, titulo: 'Marcar e remarcar por telefone', desc: 'Appointment, reschedule', tempo: 13, xp: 100 },
    { id: 4, titulo: 'E-mails e mensagens', desc: 'Formal x casual, Dear/Best', tempo: 13, xp: 100 },
    { id: 5, titulo: 'Quando a comunicação falha', desc: 'Repeat, speak slowly', tempo: 13, xp: 100 },
    { id: 6, titulo: 'Projeto: resolva tudo por telefone', desc: 'Uma ligação do início ao fim', tempo: 22, xp: 140 },
  ],
  'en-b2-expressoes': [
    { id: 1, titulo: 'O que são idioms', desc: 'Expressões de sentido figurado', tempo: 13, xp: 100 },
    { id: 2, titulo: 'Phrasal verbs essenciais', desc: 'turn on, give up, look after', tempo: 14, xp: 110 },
    { id: 3, titulo: 'Collocations', desc: 'make/do, heavy rain, fast food', tempo: 14, xp: 110 },
    { id: 4, titulo: 'Gírias e registro informal', desc: 'gonna, wanna, slang', tempo: 14, xp: 110 },
    { id: 5, titulo: 'Soar natural, não traduzido', desc: 'False friends e chunks', tempo: 14, xp: 110 },
    { id: 6, titulo: 'Projeto: fale como um nativo', desc: 'Junte idioms e naturalidade', tempo: 24, xp: 150 },
  ],
  'en-b2-midia': [
    { id: 1, titulo: 'Ler notícias e artigos', desc: 'Headlines, lead, pirâmide invertida', tempo: 13, xp: 100 },
    { id: 2, titulo: 'Filmes e séries sem legenda', desc: 'Subir a escada das legendas', tempo: 14, xp: 110 },
    { id: 3, titulo: 'Música e letras', desc: 'Lyrics e licença poética', tempo: 13, xp: 100 },
    { id: 4, titulo: 'Podcasts e áudio', desc: 'Transcript, velocidade, constância', tempo: 14, xp: 110 },
    { id: 5, titulo: 'Redes sociais e internet', desc: 'Abreviações e vocab de plataforma', tempo: 14, xp: 110 },
    { id: 6, titulo: 'Projeto: faça sua resenha', desc: 'Escreva uma review estruturada', tempo: 24, xp: 150 },
  ],
  'en-b2-fluencia': [
    { id: 1, titulo: 'Manter a conversa fluindo', desc: 'Fillers, follow-ups, turn-taking', tempo: 13, xp: 100 },
    { id: 2, titulo: 'Opinar, concordar e discordar', desc: 'Graus de opinião e ressalvas', tempo: 14, xp: 110 },
    { id: 3, titulo: 'Ganhar tempo e parafrasear', desc: 'Não travar por uma palavra', tempo: 14, xp: 110 },
    { id: 4, titulo: 'Contar histórias com fluência', desc: 'Gancho, conectores e desfecho', tempo: 14, xp: 110 },
    { id: 5, titulo: 'Debater e argumentar', desc: 'Sinalizar, exemplificar, concluir', tempo: 14, xp: 110 },
    { id: 6, titulo: 'Projeto: uma conversa espontânea', desc: 'Junte tudo numa conversa real', tempo: 24, xp: 150 },
  ],
};
...
export const TROFEUS = [
  ...
  { id: 'dom-pc-excel-pro', nome: 'Analista de Planilhas', desc: 'Concluiu Excel Avançado',     tipo: 'dominio', tier: 'gold',   mod: 'comp', icon: 'sigma',     regra: { trilha: 'pc-excel-pro' } },
